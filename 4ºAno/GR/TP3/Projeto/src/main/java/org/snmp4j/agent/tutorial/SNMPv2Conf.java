...
// --AgentGen END
{
    ...
    private static final LogAdapter LOGGER = LogFactory.getLogger(SNMPv2Conf.class);
    ...
    public static final OID oidSNMPv2Conf = new OID(new int[] {});
    ...
    /**
     * Constructs a SNMPv2Conf instance without actually creating its <code>ManagedObject</code>
    ...
    /**
     * Constructs a SNMPv2Conf instance and actually creates its <code>ManagedObject</code>
